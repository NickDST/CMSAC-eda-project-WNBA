...
sea_wgames %>% 
  ...
  scale_x_time() +
  labs(title = "Shot distance from games in Cluster 1 shows no midrange and later 3pt focus in 4th Quarter", y = "Distance From Hoop", x = "Time") + 
  theme_bw()
```
...
sea_wgames %>% 
  ...
  # scale_color_manual(values=c("cadetblue", "firebrick")) +
  scale_x_time() +
  labs(title = "Shot distance from games in Cluster 2 show more midrange and earlier 3pt focus in 4th Quarter", y = "Distance From Hoop", x = "Time") + 
  theme_bw()
```
]
